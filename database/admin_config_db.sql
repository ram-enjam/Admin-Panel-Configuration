...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2022 at 08:10 AM
...
INSERT INTO `department` (`department_id`, `department_name`, `createdon`, `inactive`) VALUES
(1, 'CSE', '2022-05-18 11:01:15', 0),
(2, 'MECH', '2022-05-18 11:01:22', 0),
(3, 'CIVIL', '2022-05-18 11:01:29', 0),
(4, 'ECE', '2022-05-18 11:01:36', 0),
(5, 'EEE', '2022-05-18 11:01:40', 0),
(6, 'H&S', '2022-05-18 11:01:48', 0),
(7, 'AI & DS', '2022-07-26 11:01:48', 0);
...
INSERT INTO `employee` (`emp_id`, `emp_name`, `phone`, `department_id`, `createdDate`, `createdBy`, `modiDate`, `modiBy`, `inActive`, `status`) VALUES
(1, 'Super Admin', '8369025279', 1, '2022-05-18 11:02:06', 0, '2022-07-25 09:58:10', 1, 0, 0),
(2, 'Principal', '9878998778', 2, '2022-05-18 11:13:21', 0, '0000-00-00 00:00:00', 0, 0, 0),
(3, 'R.T.SARATHBABU', '8596587894', 2, '2022-05-18 11:16:53', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(5, 'L.RAMA MURTHY', '9856985478', 4, '2022-05-18 11:17:24', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(6, 'K KRISHNA REDDY', '9856475125', 5, '2022-05-18 11:17:35', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(7, 'C.S. DAWRAKA VISWANATH', '7896548547', 6, '2022-05-18 11:17:49', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(8, 'U. KUMARAN', '8369025279', 1, '2022-05-25 09:53:08', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(9, 'SARATH', '8569584758', 3, '2022-06-15 10:57:13', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(10, 'Placement Person', '9854785965', 2, '2022-06-15 11:03:21', 0, '0000-00-00 00:00:00', 2022, 0, 0),
(11, 'Academic Person', '8565958475', 5, '2022-06-15 11:04:39', 0, '0000-00-00 00:00:00', 0, 0, 0),
(12, 'Admission Person', '9854785623', 6, '2022-06-15 11:05:09', 0, '0000-00-00 00:00:00', 0, 0, 0),
(13, 'Kamalesh', '8569547852', 1, '2022-06-17 18:18:55', 0, '0000-00-00 00:00:00', 0, 0, 0),
(14, 'AI & DS Emp', '8956259985', 7, '2022-07-26 12:19:12', 0, '0000-00-00 00:00:00', 0, 0, 0),
(15, 'Extension Activity Member', '8525825825', 6, '2022-07-27 10:32:35', 0, '0000-00-00 00:00:00', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `form_career`
--

CREATE TABLE `form_career` (
  `id` int(11) NOT NULL,
  ...
  `current_job` varchar(55) NOT NULL,
  `current_org` varchar(255) NOT NULL,
  `current_loc` varchar(55) NOT NULL,
  `language` varchar(55) NOT NULL,
  `ug_college` varchar(255) NOT NULL,
  `pg_college` varchar(255) NOT NULL,
  `phd_college` varchar(255) NOT NULL,
  `resume` varchar(55) NOT NULL,
...
--
-- Dumping data for table `form_career`
--

INSERT INTO `form_career` (`id`, `firstname`, `lastname`, `email`, `mobile`, `gender`, `job_title`, `department`, `work_exp`, `highest_qualification`, `age`, `current_job`, `current_org`, `current_loc`, `language`, `ug_college`, `pg_college`, `phd_college`, `resume`, `created_date`, `read_status`, `a_status`) VALUES
(1, 'Ram', 'Enjam', 'ramenjam07@gmail.com', '8369025279', 'male', 'Associate Professor', 'CSE/IT', '1', 'MA/ MSc/ MCom', '24', 'Software Developer', 'Youngminds Technology Solutions', 'Tirupati', 'telugu', 'Pillai College of arts, commerce & science', 'Pillai College of arts, commerce & science', 'Pillai College of arts, commerce & science', '1653367855.pdf', '2022-06-14 12:48:58', 0, ''),
(2, 'Nani', 'Cimbili', 'support@ymtsindia.com', '8328345439', 'male', 'Professor / HOD', 'ECE', '5', 'PhD', '2', 'Lecturare', 'VEMU', 'Pakala', 'telugu', 'Padmavati', 'Sai venkateswara', 'SVU', '1655191024.pdf', '2022-06-14 12:49:00', 0, ''),
(3, 'Kiran', 'Cimbili', 'kiran@gmail.com', '8328345436', 'male', 'Associate Professor', 'CSE/IT', '2', 'Highest Qualification *', '23', '', '', 'Hyderabad', 'telugu', '', '', '', '1655267776.pdf', '2022-06-15 10:06:16', 0, ''),
(4, 'Kiran', 'Cimbili', 'kiran@gmail.com', '8328345436', 'male', 'Associate Professor', 'CSE/IT', '2', 'Highest Qualification *', '23', '', '', 'Hyderabad', 'telugu', '', '', '', '1655267967.pdf', '2022-06-15 10:09:27', 0, ''),
(5, 'Kiran', 'Cimbili', 'kiran@gmail.com', '8328345436', 'male', 'Associate Professor', 'CSE/IT', '2', 'Highest Qualification *', '23', '', '', 'Hyderabad', 'telugu', '', '', '', '1655267968.pdf', '2022-06-15 10:18:05', 1, 'bnvvcxz'),
(6, 'Vani', 'A', 'test@gmail.com', '8328345430', 'female', 'Associate Professor', 'ECE', '4', 'Other', '35', '', '', 'Banglore', 'non-telugu', '', '', '', '1655268458.pdf', '2022-06-15 10:17:37', 1, 'test');

-- --------------------------------------------------------

--
-- Table structure for table `form_career_log`
--

CREATE TABLE `form_career_log` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `form_career_log`
--

INSERT INTO `form_career_log` (`id`, `lead_id`, `status`, `status_date`, `updated_by`) VALUES
(1, '6', 'test', '2022-07-06 12:27:47', 'ADMIN'),
(2, '5', 'bnvvcxz', '2022-07-06 12:30:17', 'admin');
...
INSERT INTO `form_contact` (`id`, `firstname`, `lastname`, `email`, `mobile`, `message`, `created_date`, `read_status`, `a_status`) VALUES
(1, 'dasdas', 'sadsda', 'sda@g.c', '9876549087', 'ads', '2022-07-06 10:50:03', 1, 'test'),
(2, 'dasdas', 'sadsda', 'sda@g.c', '9876549087', 'ads', '2022-07-06 11:36:29', 1, 'I had a call, lead is looking positive '),
(3, 'Test', 'Test', 'admin', '9877655788', 'test', '2022-05-21 15:34:32', 0, ''),
(4, 'Shashank', 'C', 'lavanya@ymtsindia.org', '8328345439', 'test message', '2022-06-14 12:32:33', 0, ''),
(5, 'Lakuy', 'J', 'lucky@gmail.com', '8328456789', 'Will contact soon', '2022-06-14 16:37:08', 0, ''),
(6, 'dfdd', 'sdd', 'dfgdfg', '8757868878', 'fgfdg', '2022-06-14 16:38:43', 0, ''),
(7, 'pRaVEen', 'iyLI', 'praveen@gmail.com', '8197431230', 'hi world', '2022-07-06 11:38:08', 1, 'assd');

-- --------------------------------------------------------

--
-- Table structure for table `form_contact_log`
--

CREATE TABLE `form_contact_log` (
  `id` int(11) NOT NULL,
  `lead_id` varchar(255) NOT NULL,
  `status` varchar(255) NOT NULL,
  `status_date` datetime NOT NULL,
...
--
-- Dumping data for table `form_contact_log`
--

INSERT INTO `form_contact_log` (`id`, `lead_id`, `status`, `status_date`, `updated_by`) VALUES
(1, '1', 'test', '2022-07-06 10:50:03', 'admin'),
(2, '2', 'long test data with unknown data and useless data djg aksdhbf sahdsaigdsjds  sdhasidgsabm sdhasidg   mgdasdgasjb shdiasgdjsd asbdusadgsajdsa dasgduasgdasjdnas djsgdsuabdsand sajg saljdgasudvskhd asjdgasudgaskdv ', '2022-07-06 10:55:20', 'admin'),
(3, '2', 'I had a call, lead is looking positive ', '2022-07-06 11:36:29', 'principal'),
(4, '7', 'testing this id', '2022-07-06 11:38:08', 'ADMIN'),
(5, '7', 'testing alert', '2022-07-06 11:49:49', 'ADMIN'),
(6, '7', 'assd', '2022-07-06 11:52:04', 'ADMIN');

-- --------------------------------------------------------

--
-- Table structure for table `form_enquiry`
--

CREATE TABLE `form_enquiry` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `form_enquiry`
--

INSERT INTO `form_enquiry` (`id`, `name`, `email`, `mobile`, `message`, `created_date`, `read_status`, `a_status`) VALUES
(1, 'Ram', 'ram@gmail.comq', '8955485689', 'das', '2022-05-23 11:00:32', 0, ''),
(2, 'Geethika', 'geethika@gmail.com', '8585689585', 'test', '2022-05-25 09:48:34', 0, ''),
(3, 'Lavanya', 'lavanya@ymtsindia.org', '8328345436', 'test', '2022-06-14 12:26:28', 0, ''),
(4, 'Kiran', 'test@gmail.com', '8328345436', '', '2022-06-14 15:32:57', 0, ''),
(5, 'Praveen ', 'praveen@gmail.com', '8197431230', 'Hello world', '2022-06-14 16:04:41', 0, ''),
(6, 'PRAVEEN ', 'PRAVEEN1@GMAIL.COM', '8197431230', 'HI world', '2022-06-14 16:05:18', 0, ''),
(7, 'fwe', 's@h.com', '8776976876', 'se', '2022-07-01 17:57:26', 1, 'test');

-- --------------------------------------------------------

--
-- Table structure for table `form_enquiry_log`
--

CREATE TABLE `form_enquiry_log` (
  `id` int(11) NOT NULL,
  `lead_id` varchar(255) NOT NULL,
  `status` varchar(255) NOT NULL,
  `status_date` datetime NOT NULL,
...
--
-- Dumping data for table `form_enquiry_log`
--

INSERT INTO `form_enquiry_log` (`id`, `lead_id`, `status`, `status_date`, `updated_by`) VALUES
(5, '7', 'test', '2022-07-06 12:06:44', 'ADMIN');
...
INSERT INTO `users` (`user_id`, `insert_date`, `user_role`, `user_empid`, `username`, `password`, `createdDate`, `createdBy`, `modifiedDate`, `modifiedBy`, `inActive`, `status`) VALUES
(1, '2022-09-28', 1, 1, 'admin', 'admin', '2022-09-28 11:07:12', '1', '2022-09-28 11:07:12', '1', 0, 0);
...
CREATE TABLE `user_roles` (
  ...
  `permitted_days` tinyint(2) NOT NULL,
...
INSERT INTO `user_roles` (`role_id`, `module`, `role_name`, `role_description`, `permitted_days`, `inActive`) VALUES
(1, 'Administrator', 'Super Admin', 'Have access to create user, add notifications, events, news', 0, 0);
...
--
-- Indexes for table `form_career`
--
ALTER TABLE `form_career`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `form_career_log`
--
ALTER TABLE `form_career_log`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `form_contact_log`
--
ALTER TABLE `form_contact_log`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `form_enquiry`
--
ALTER TABLE `form_enquiry`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `form_enquiry_log`
--
ALTER TABLE `form_enquiry_log`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `form_career`
--
ALTER TABLE `form_career`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `form_career_log`
--
ALTER TABLE `form_career_log`
...
--
-- AUTO_INCREMENT for table `form_contact_log`
--
ALTER TABLE `form_contact_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `form_enquiry`
--
ALTER TABLE `form_enquiry`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `form_enquiry_log`
--
ALTER TABLE `form_enquiry_log`
