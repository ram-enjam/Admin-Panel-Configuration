...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>backend/app-assets/images/ico/apple-icon-120.png">
      ...
      <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
        <div class="card-header border-0 pb-0">
          <div class="card-title text-center">
            <img src="<?php echo base_url(); ?>backend/app-assets/images/logo/logo-dark.png" alt="branding logo">
          </div>
        ...
        <div class="card-content">
          ...
          <div class="card-body">
            <a href="<?php echo base_url().'login'; ?>" class="btn btn-outline-danger btn-block"><i class="ft-unlock"></i>
              Login</a>
          </div>
        </div>
      </div>
