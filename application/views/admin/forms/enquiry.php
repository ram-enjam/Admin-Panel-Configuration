        ...
        <aside class="right-side" style="background:whitesmoke;">
            <section class="content-header">
                <ol class="breadcrumb" style="margin-top:0;margin-left:-25px;">
                    ...
                    <li><a href="<?php echo base_url() ?>admin/adminpage/enquiry_details">Enquiries</a></li>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo base_url() ?>admin/adminpage/enquiry_details">
                                                ...
                                                <td class="text-center">
                                                                ...
                                                                <script>
                                                                    function statusSubmit(row, id) {
                                                                        if ($("#new_status" + row).val() == "") {
                                                                            ...
                                                                            $.ajax({
                                                                                type: "POST",
                                                                                url: "<?php echo base_url() . 'admin/adminpage/enquiryform_status'; ?>",
                                                                                data: {
                                                                                    id: $("#id" + row).val(),
                                                    ...
                                                    <script>
                                                        function myHistory(id) {
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo base_url() . 'admin/adminpage/enquiryform_history'; ?>",
                                                                data: {
                                                                    id: id,
                                                                },
                                                                success: function(data) {
