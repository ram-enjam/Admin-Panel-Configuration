        ...
        <aside class="right-side" style="background:whitesmoke;">
            <section class="content-header">
                <ol class="breadcrumb" style="margin-top:0;margin-left:-25px;">
                    ...
                    <li><a href="<?php echo base_url() ?>admin/adminpage/contact_details">Contact</a></li>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo base_url() ?>admin/adminpage/contact_details">
                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $result) {
                                            $i++;
                                        ?>
                                            <tr class="mark<?php echo $result->id ?> <?php if ($result->read_status == 0) {echo "mark-unread";} ?>">
                                                <td class="text-center">
                                                                ...
                                                                <script>
                                                                    function statusSubmit(row, id) {
                                                                        if ($("#new_status" + row).val() == "") {
                                                                            ...
                                                                            $.ajax({
                                                                                type: "POST",
                                                                                url: "<?php echo base_url() . 'admin/adminpage/contactform_status'; ?>",
                                                                                data: {
                                                                                    id: $("#id" + row).val(),
                                                    ...
                                                    <script>
                                                        function myHistory(id) {
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo base_url() . 'admin/adminpage/contactform_history'; ?>",
                                                                data: {
                                                                    id: id,
                                                                },
                                                                success: function(data) {
                                                ...
                                                <td class="text-center"><a class="btn btn-info" href="#" data-toggle="tooltip" data-placement="left" title="<?php echo $result->message; ?>">View</a></td>
                                                <td><?php echo date("d M", strtotime($result->created_date)); ?></td>
