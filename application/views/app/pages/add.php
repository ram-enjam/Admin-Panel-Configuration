                 ...
                 <div class="row">
                 	<div class="col-md-12" style="margin-left:0;padding-left:10px;margin-top:20px;">
                    	 ...
                    	 <div class="box">
                            	...
                            	<form role="form" method="post" action="<?php echo base_url()?>app/pages/save" onSubmit="return confirm('Are you sure you want to save?');">
                                
                                		<?php echo validation_errors(); ?>   
                                
                                		<div class="form-group">
                                            <a href="<?php echo base_url();?>app/pages" class="btn btn-default">Cancel</a>
                                            <button class="btn btn-primary" name="btnSubmit" id="btnSubmit" type="submit"><i class="ft-save"></i> Save</button>
                                        </div>
                                		<div class="form-group">
                                        	<div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                            	<input class="form-control input-sm" name="page_module" id="page_module" type="text" placeholder="Page Module" style="width: 250px;" required>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                            	<input class="form-control input-sm" name="page_name" id="page_name" type="text" placeholder="Page Name" style="width: 250px;" required>
                                            </div>
                                            <div class="clearfix"> </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                            	<input class="form-control input-sm" name="page_link" id="page_link" type="text" placeholder="Page Link" style="width: 250px;" required>
                                            </div>
                                            <div class="clearfix"> </div>
                                        </div>
